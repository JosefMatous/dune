...
if __name__ == "__main__":
    #2.2418  -29.2002   12.1048  -10.5643    8.7561  -36.4400
    #35.8463   28.9486   16.2551   -9.7894   -3.5999    4.2887
    #0.0029    1.6858    0.4574    1.4931    1.4633    0.9949
    offset = [(2.-50.,35.), (-25.-50.,35.), (12.-50.,16.), (-10.-50.,-10.), (9.-50.,-4.), (-36.-50.,4.)]
    orientation = [0., -np.pi/2, np.pi/2, -np.pi/2, -np.pi/2, np.pi]
    L1 = 60.
    L2 = 200.
