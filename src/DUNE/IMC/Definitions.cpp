...
namespace DUNE
{
  namespace IMC
  {
    ...
    TrajectoryReference::TrajectoryReference(void)
    {
      m_header.mgid = 2030;
      clear();
    }
    ...
    void
    TrajectoryReference::clear(void)
    {
      r_x = 0;
      r_y = 0;
      r_z = 0;
    ...
    bool
    TrajectoryReference::fieldsEqual(const Message& msg__) const
    {
      const IMC::TrajectoryReference& other__ = static_cast<const TrajectoryReference&>(msg__);
      if (r_x != other__.r_x) return false;
      if (r_y != other__.r_y) return false;
      if (r_z != other__.r_z) return false;
    ...
    int
    TrajectoryReference::validate(void) const
    {
      return true;
    }

    uint8_t*
    TrajectoryReference::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(r_x, ptr__);
      ptr__ += IMC::serialize(r_y, ptr__);
      ptr__ += IMC::serialize(r_z, ptr__);
    ...
    uint16_t
    TrajectoryReference::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(r_x, bfr__, size__);
      bfr__ += IMC::deserialize(r_y, bfr__, size__);
      bfr__ += IMC::deserialize(r_z, bfr__, size__);
    ...
    uint16_t
    TrajectoryReference::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(r_x, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(r_y, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(r_z, bfr__, size__);
    ...
    void
    TrajectoryReference::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "r_x", r_x, nindent__);
      IMC::toJSON(os__, "r_y", r_y, nindent__);
      IMC::toJSON(os__, "r_z", r_z, nindent__);
    ...
    bool
    HandPosIn::fieldsEqual(const Message& msg__) const
    {
      const IMC::HandPosIn& other__ = static_cast<const HandPosIn&>(msg__);
      if (type != other__.type) return false;
      if (u_x != other__.u_x) return false;
      if (u_y != other__.u_y) return false;
      if (u_z != other__.u_z) return false;
      if (reference != other__.reference) return false;
      return true;
    }

    int
    HandPosIn::validate(void) const
    {
      return true;
    }

    uint8_t*
    HandPosIn::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(type, ptr__);
      ptr__ += IMC::serialize(u_x, ptr__);
      ptr__ += IMC::serialize(u_y, ptr__);
      ptr__ += IMC::serialize(u_z, ptr__);
      ptr__ += reference.serialize(ptr__);
      return ptr__;
    }

    uint16_t
    HandPosIn::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(type, bfr__, size__);
      bfr__ += IMC::deserialize(u_x, bfr__, size__);
      bfr__ += IMC::deserialize(u_y, bfr__, size__);
      bfr__ += IMC::deserialize(u_z, bfr__, size__);
      bfr__ += reference.deserialize(bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    HandPosIn::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(type, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(u_x, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(u_y, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(u_z, bfr__, size__);
      bfr__ += reference.reverseDeserialize(bfr__, size__);
      return bfr__ - start__;
    }

    void
    HandPosIn::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "type", type, nindent__);
      IMC::toJSON(os__, "u_x", u_x, nindent__);
      IMC::toJSON(os__, "u_y", u_y, nindent__);
      IMC::toJSON(os__, "u_z", u_z, nindent__);
      reference.toJSON(os__, "reference", nindent__);
    }

    void
    HandPosIn::setTimeStampNested(double value__)
    {
      if (!reference.isNull())
      {
        reference.get()->setTimeStamp(value__);
    ...
    void
    HandPosIn::setSourceNested(uint16_t value__)
    {
      if (!reference.isNull())
      {
        reference.get()->setSource(value__);
    ...
    void
    HandPosIn::setSourceEntityNested(uint8_t value__)
    {
      if (!reference.isNull())
      {
        reference.get()->setSourceEntity(value__);
    ...
    void
    HandPosIn::setDestinationNested(uint16_t value__)
    {
      if (!reference.isNull())
      {
        reference.get()->setDestination(value__);
    ...
    void
    HandPosIn::setDestinationEntityNested(uint8_t value__)
    {
      if (!reference.isNull())
      {
        reference.get()->setDestinationEntity(value__);
    ...
    ExperimentControl::fieldsEqual(const Message& msg__) const
    {
      ...
      if (start != other__.start) return false;
    ...
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(start, ptr__);
    ...
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(start, bfr__, size__);
