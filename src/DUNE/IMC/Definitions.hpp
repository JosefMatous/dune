...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! Group Estimated State.
    class GroupEstimatedState: public Message
    {
    public:
      //! Estimated State List.
      MessageList<EstimatedState> estate_list;
      ...
      GroupEstimatedState(void);

      GroupEstimatedState*
      clone(void) const
      {
        return new GroupEstimatedState(*this);
      }
      ...
      getId(void) const
      {
        return GroupEstimatedState::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "GroupEstimatedState";
      }
      ...
      getVariableSerializationSize(void) const
      {
        return estate_list.getSerializationSize();
      }
