...
namespace DUNE
{
  namespace IMC
  {
    ...
    class TrajectoryReference: public Message
    {
    public:
      //! Position x.
      fp64_t r_x;
      ...
      TrajectoryReference(void);

      TrajectoryReference*
      clone(void) const
      {
        return new TrajectoryReference(*this);
      }
      ...
      getId(void) const
      {
        return TrajectoryReference::getIdStatic();
      }
    ...
    //! Hand Position Input.
    class HandPosIn: public Message
    {
    public:
      //! Input Type.
      enum InputTypeBits
      ...
      fp64_t u_z;
      //! Reference.
      InlineMessage<TrajectoryReference> reference;
